...
const PresentingComplaintsSection: React.FC<
...
const ChronicConditionsSection: React.FC<ChronicConditionsSectionProps> = ({
  data,
  onChange,
}) => {
...
const PastHistorySection: React.FC<PastHistorySectionProps> = ({
  data,
  onChange,
  chronicMeds,
}) => {
...
const AiClinicalSummarySection: React.FC<AiClinicalSummarySectionProps> = ({
  summary,
  isLoading,
  isExpanded,
  onToggleExpand,
