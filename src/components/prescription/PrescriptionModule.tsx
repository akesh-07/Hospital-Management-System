...
export const PrescriptionModule: React.FC = () => {
  ...
  const commonMedications = [
    'Paracetamol', 'Ibuprofen', 'Metformin', 'Lisinopril', 'Omeprazole',
    'Aspirin', 'Atorvastatin', 'Amoxicillin', 'Losartan', 'Pantoprazole'
  ];

  const dosageOptions = ['250mg', '500mg', '1g', '5mg', '10mg', '25mg', '50mg', '100mg'];
  const frequencyOptions = ['Once daily', 'Twice daily', 'Thrice daily', 'Four times daily', 'As needed'];
  const durationOptions = ['3 days', '5 days', '7 days', '10 days', '2 weeks', '1 month'];
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Prescription & Advice</h1>
              <p className="text-gray-600">Create detailed prescription and treatment plan</p>
            </div>
          </div>
          <div className="bg-white rounded-lg border border-gray-200 p-4">
            <p className="font-semibold text-gray-900">{selectedPatient.name}</p>
            <p className="text-sm text-gray-600">{selectedPatient.uhid} • {selectedPatient.age}Y</p>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">General Advice</h3>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              ...
              <div className="space-y-3">
                {dietPlans.map((plan) => (
                  <label key={plan} className="flex items-start space-x-3 cursor-pointer">
                    <input
                      type="checkbox"
              ...
              {advice.followUp.enabled && (
                <>
                  ...
                  <select
                    ...
                    onChange={(e) => setAdvice(prev => ({
                      ...prev,
                      followUp: { ...prev.followUp, unit: e.target.value as 'Days' | 'Months' | 'Years' }
                    }))}
          ...
          <div className="flex items-center justify-between p-6 bg-white rounded-lg border border-gray-200">
            ...
            <button className="flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-lg hover:from-green-700 hover:to-blue-700 transition-colors">
